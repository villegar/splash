...
# lockBinding("kalb_vis", globalenv())
# lockBinding("kb", globalenv())
# lockBinding("kc", globalenv())
# lockBinding("kCw", globalenv())
# lockBinding("kd", globalenv())
# lockBinding("kfFEC", globalenv())
# lockBinding("kG", globalenv())
# lockBinding("kGsc", globalenv())
# lockBinding("kL", globalenv())
# lockBinding("kMa", globalenv())
# lockBinding("kMv", globalenv())
# lockBinding("kSecInDay", globalenv())
# lockBinding("kPo", globalenv())
# lockBinding("kR", globalenv())
# lockBinding("kTo", globalenv())
# lockBinding("kWm", globalenv())
# lockBinding("kw", globalenv())
# lockBinding("pir", globalenv())
#
# lockBinding("ke", globalenv())
# lockBinding("keps", globalenv())
# lockBinding("komega", globalenv())
